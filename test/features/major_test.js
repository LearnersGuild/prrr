    ...
    withUsersInTheDatabase(function(){
      it('runs through scenario of a player creating a prrr and a coach seeing a new prrr being added and claims it', function(){
        ...
        //Create initial state for testing
          ...
          .then(_ => player.clickByClassName('Navbar-button-add-prrr'))
          ...
          .then(_ => player.clickByClassName('RequestReviewPage-Button'))
          ...
          .then(_ => player.clickOn('https://github.com/AbrahamFergie/Obeisant-Gecko/pull/6'))
          .then(_ => player.clickOn('https://github.com/AbrahamFergie'))
          //closes popup tabs
          ...
          .then(_ => coach.clickByClassName('Button-default ReviewButton'))
